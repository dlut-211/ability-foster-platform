...
public class FnDumpDblogXtpWithBLOBs extends FnDumpDblogXtp {
    ...
    private byte[] newrowData;

    private byte[] oldrowKeyData;
    ...
    public byte[] getNewrowData() {
        return newrowData;
    }

    public void setNewrowData(byte[] newrowData) {
        this.newrowData = newrowData;
    }

    public byte[] getOldrowKeyData() {
        return oldrowKeyData;
    }

    public void setOldrowKeyData(byte[] oldrowKeyData) {
        this.oldrowKeyData = oldrowKeyData;
    }
}